...
merchant_type = ['fraud_Rippin, Kub and Mann', 'fraud_Heller, Gutmann and Zieme',
...
category_type = ['misc_net', 'grocery_pos', 'entertainment', 'gas_transport',
       'misc_pos', 'grocery_net', 'shopping_net', 'shopping_pos',
       'food_dining', 'personal_care', 'health_fitness', 'travel',
       'kids_pets', 'home']

job_type = ['Psychologist, counselling', 'Special educational needs teacher',
       ...
       'Armed forces technical officer', 'Forest/woodland manager',
       'Personnel officer', 'Industrial buyer',
       'Sales promotion account executive', 'Accountant, chartered',
       'Air traffic controller', 'Careers adviser', 'Information officer',
       'Ship broker', 'Legal secretary', 'Homeopath', 'Dancer',
       'Engineer, site', 'Contracting civil engineer',
       'Veterinary surgeon', 'Solicitor', 'Warehouse manager',
